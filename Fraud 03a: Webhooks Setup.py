...
create_job_webhook(model_name = "VR Fraud Model", job_id = job_id)
...
# MAGIC
# MAGIC Using MLFlow webhook, we'll trigger a slack notification and a validation job as soon as a Data Scientist request a model to be moved to Staging!
# MAGIC
